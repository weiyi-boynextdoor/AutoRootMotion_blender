...
#     # Find the pelvis bone (common Mixamo names)
#     pelvis_names = ["Hips", "pelvis", "Pelvis", "mixamorig:Hips"]
#     pelvis_bone = None
    
#     for name in pelvis_names:
#         if name in armature.edit_bones:
#             pelvis_bone = armature.edit_bones[name]
#             break
    
#     if not pelvis_bone:
#         print("Could not find pelvis bone. Available bones:", list(armature.edit_bones.keys()))
#         return False
    
#     print(f"Found pelvis bone: {pelvis_bone.name}")
    
#     # Create root bone
#     root_bone = armature.edit_bones.new("Root")
#     root_bone.head = pelvis_bone.head.copy()
#     root_bone.head.z = 0  # Place at ground level
#     root_bone.tail = root_bone.head + Vector((0, 0.1, 0))  # Small bone pointing forward
...
#             root_curve = action.fcurves.new(f"pose.bones["Root"].location", index=axis)
...
#     print("Adding root bone to selected Mixamo armature...")
#     success = add_root_bone_to_mixamo()
    
#     if success:
#         print("Process completed successfully!")
#         print("\nNext steps for UE5:")
#         print("1. Export as FBX with "Bake Animation" enabled")
#         print("2. In UE5, set "Root Motion Root Lock" to "Root" bone")
#         print("3. Enable "Force Root Lock" in animation settings")
#         print("4. Use "Root Motion from Everything" in AnimBP")
    
#     # Uncomment below for batch processing
#     # batch_directory = "/path/to/your/mixamo/files"
#     # batch_process_mixamo_files(batch_directory)